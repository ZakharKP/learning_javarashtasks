...
import com.javarush.bigtask.task36.task3608.Util;
import com.javarush.bigtask.task36.task3608.bean.User;
import com.javarush.bigtask.task36.task3608.dao.UserDao;
...
public class UserServiceImpl implements UserService {
	...
	public List<User> getUsersBetweenLevels(int fromLevel, int toLevel) {
		// it's better to get all users from DAO by one DB request, but we will use what
		// we have
		List<User> result = new ArrayList<>();
