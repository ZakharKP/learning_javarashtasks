...
public class House<T> {
	...
	/*
	 * private void checkConflicts() { boolean conflict = false; for (Object
	 * resident : residents) { if (resident instanceof Dog) { conflict = true; } }
	 * 
	 * if (conflict) { Iterator iterator = residents.iterator(); while
	 * (iterator.hasNext()) { Object resident = iterator.next(); if (resident
	 * instanceof Cat) { iterator.remove(); } } } }
	 */
	@Override
