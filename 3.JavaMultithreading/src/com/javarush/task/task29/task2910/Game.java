...
import static com.javarush.task.task29.task2910.Constants.SPORTSMAN_COUNT;
...
public class Game {
	...
	private void initializeControlSportsman() {
		...
		System.out.println("RESULT OF THE CONTROL ATHLET:");
	...
	public void startCompetition() {
		for (int i = 0; i < members.size(); i++) {
			...
			BigDecimal timeToRace = controlSportsman.getResultTime()
					.subtract(BigDecimal.valueOf(members.get(i).getCountHitOutTarget() * PENALTY_TIME_PER_ONE_MISS));
			members.get(i).setAverageSpeed(new BigDecimal(RACE_LENGTH / (timeToRace.doubleValue() / 3600)).setScale(4,
