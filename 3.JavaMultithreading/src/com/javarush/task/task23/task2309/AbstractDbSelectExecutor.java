...
public abstract class AbstractDbSelectExecutor<T extends NamedItem> {
	...
	// reflection
	// you need to know that it is possible to create a new instance of the T
	// (generic type) class using its default constructor
	private T getNewInstanceOfGenericType() throws InstantiationException, IllegalAccessException {
		return (T) ((Class) ((ParameterizedType) this.getClass().getGenericSuperclass()).getActualTypeArguments()[0])
				.newInstance();
	}
}
