...
public class Solution {
	...
	public static synchronized void moveMoney(Account from, Account to, int amount) {
		...
		Thread.yield();
		System.out.printf("Transaction #%d: Withdraw $%d from account #%d. Balance: %d.%n", transactionNumber, amount,
				from.getNumber(), from.getBalance());
		from.setBalance(from.getBalance() - amount);
		Thread.yield();
		System.out.printf("Transaction #%d: credited $%d to account #%d. Balance: %d.%n", transactionNumber, amount,
	...
	static class Account {
		...
		public void checkBalance() {
			System.out.println(this.number + ": checking...");
